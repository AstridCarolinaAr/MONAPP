...
document.addEventListener("submit", function (e) {
  ...
  // Solo interceptar los forms de anular venta
  if (!form.classList.contains("form-anular-venta")) return;

  // Frenar el envío normal (si no haces esto, se borra directo)
  e.preventDefault();
  ...
  Swal.fire({
    ...
    text: "La venta cambiará a estado anulada.",
    icon: "warning",
