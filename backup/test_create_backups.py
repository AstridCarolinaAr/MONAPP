...
from backup.services import crear_backup_base_datos, crear_backup_completo, crear_backup_media, get_database_stats
...
try:
    # Prueba 1: Backup de base de datos
    ...
    try:
        ...
        print(f"     - Tamaño: {backup_bd.tamano_legible}")
        print(f"     - Archivo existe: {'✓' if backup_bd.archivo_existe else '✗'}")
    except Exception as e:
        print(f"   ✗ Error: {str(e)}")

    # Prueba 2: Backup completo
    ...
    try:
        ...
        print(f"     - Tamaño: {backup_completo.tamano_legible}")
        print(f"     - Archivo existe: {'✓' if backup_completo.archivo_existe else '✗'}")
    except Exception as e:
        print(f"   ✗ Error: {str(e)}")

    # Prueba 3: Backup de media
    ...
    try:
        ...
        print(f"     - Tamaño: {backup_media.tamano_legible}")
        print(f"     - Archivo existe: {'✓' if backup_media.archivo_existe else '✗'}")
    except Exception as e:
        print(f"   ✗ Error: {str(e)}")

    # Mostrar todos los backups creados
    print("\n" + "=" * 70)
    ...
    for i, b in enumerate(backups, 1):
        ...
        print(f"   - Tamaño: {b.tamano_legible} | Duración: {b.duracion_segundos}s")
